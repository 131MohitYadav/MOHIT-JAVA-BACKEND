<%-- 
    Document   : feditform
    Created on : 3 Apr, 2025, 8:47:06 PM
    Author     : yadav
--%>
...
<h1 class="head1">FACULTY UPDATE FORM</h1>
...
<form action="fupdate.jsp" method="post">
    <table width="60%">
        <tr>
            <td>FID: </td>
            <td><input type="text" name="fid" value="<%= sb.getFid() %>"></td>
        </tr>
        <tr>
            <td>NAME: </td>
        ...
        <tr>
            <td>GENDER: </td>
            <td><input type="text" name="gen" value="<%= sb.getGender() %>"></td>
        </tr>
        <tr>
            <td>D.O.B: </td>
        ...
        <tr>
            <td>HIRE DATE: </td>
            <td><input type="text" name="hired" value="<%= sb.getHiredate() %>"></td>
        </tr>
        <tr>
            <td>EMAIL: </td>
        ...
        <tr>
            ...
            <td><input type="text" name="dept" value="<%= sb.getDept() %>"></td>
        </tr>
        <tr>
            <td>SALARY: </td>
            <td><input type="text" name="sal" value="<%= sb.getSalary() %>"></td>
        </tr>
        <tr>
            <td>DESIGNATION: </td>
            <td><input type="text" name="desi" value="<%= sb.getDesi() %>"></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td><input type="submit" value="Update Faculty"></td>
        </tr>
    </table>
</form>
